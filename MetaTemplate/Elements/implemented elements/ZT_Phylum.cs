...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the PHYLUM classification associated with a zoological taxonomy </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ZT_Phylum : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ZT_Phylum, used in the metadata
        /// template to display and allow the user to edit the phylum 
        /// classification associated with a zoological taxonomy </summary>
        public ZT_Phylum()
            : base("Phylum")
        {
            // Set the type of this object
            base.type = Element_Type.ZT_Phylum;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            {
                darwinCoreInfo.Phylum = String.Empty;
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (darwinCoreInfo != null)
            {
                base.thisBox.Text = darwinCoreInfo.Phylum;
            }
        }
    }
}
