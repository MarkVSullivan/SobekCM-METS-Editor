...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the degree for an Electronic Thesis and Dissertation (ETD) material </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ETD_Degree : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ETD_Degree, used in the metadata
        /// template to display and allow the user to edit the degree for an 
        /// Electronic Thesis and Dissertation (ETD) material </summary>
        public ETD_Degree() : base("Degree")
        {
            // Set the type of this object
            base.type = Element_Type.ETD_Degree;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            if (thesisInfo != null)
            {
                thesisInfo.Degree = String.Empty;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (base.thisBox.Text.Trim().Length > 0)
            {
                ...
                thesisInfo.Degree = base.thisBox.Text.Trim();
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (thesisInfo != null)
            {
                base.thisBox.Text = thesisInfo.Degree;
            }
        }
    }
}
