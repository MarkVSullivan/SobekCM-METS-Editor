...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the inscription related to an item and encoded in VRACore.</summary>
    ...
    public class VRA_Inscription_Element : simpleTextBox_Element
    {
        ...
        public VRA_Inscription_Element()
            : base("Inscription")
        {
            // Set the type of this object
            base.type = Element_Type.VRA_Inscription;
        ...
        protected override void Inner_Set_Language(Template_Language newLanguage)
        {
            switch (newLanguage)
            {
                ...
                case Template_Language.French:
                    ...
                    break;
                default:
                    base.title = "Inscription - unknown";
                    break;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (thisBox.Text.Trim().Length > 0)
            {
                ...
                vraInfo.Add_Inscription(thisBox.Text.Trim());
            }
        }
        ...
        {
            VRACore_Info vraInfo = Bib.Get_Metadata_Module(GlobalVar.VRACORE_METADATA_MODULE_KEY) as VRACore_Info;
            if ((vraInfo != null) && (base.index < vraInfo.Inscription_Count))
            {
                base.thisBox.Text = vraInfo.Inscriptions[base.index];
            }
        }
    }
}