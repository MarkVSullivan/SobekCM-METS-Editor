...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the subaccount information of a bibliographic package for the Florida Dark Archive.</summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.<br /><br />
    /// Written by Mark Sullivan ( 2006 ).</remarks>
    public class FDA_SubAccount_Element : simpleTextBox_Element
    {
        /// <summary> Constructor for a new FDA_Account_Element, used in the metadata
        /// template to display and allow the user to edit the subaccount information for a 
        /// bibliographic package for the Florida Dark Archive. </summary>
        public FDA_SubAccount_Element()
            : base("FDA SubAccount")
        {
            // Set the type of this object
            base.type = Element_Type.FDA_SubAccount;
        ...
        protected override void Inner_Set_Language(Template_Language newLanguage)
        {
            switch (newLanguage)
            {
                case Template_Language.English:
                    base.title = "FDA SubAccount";
                    break;
                case Template_Language.Spanish:
                    base.title = "Subcuenta la FDA";
                    break;
                case Template_Language.French:
                    base.title = "Sous-Compte pour la FDA";
                    break;
                default:
                    base.title = "FDA SubAccount";
                    break;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            if (daitssInfo != null)
                daitssInfo.SubAccount = String.Empty;
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (thisBox.Text.Trim().Length > 0)
            {
                ...
                daitssInfo.SubAccount = thisBox.Text.Trim();
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            DAITSS_Info daitssInfo = Bib.Get_Metadata_Module(GlobalVar.DAITSS_METADATA_MODULE_KEY) as DAITSS_Info;
            if (daitssInfo != null)
                base.thisBox.Text = daitssInfo.SubAccount;
        }
    }
}
