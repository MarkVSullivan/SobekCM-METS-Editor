...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the FAMILY classification associated with a zoological taxonomy </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ZT_Family : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ZT_Family, used in the metadata
        /// template to display and allow the user to edit the family 
        /// classification associated with a zoological taxonomy </summary>
        public ZT_Family()
            : base("Family")
        {
            // Set the type of this object
            base.type = Element_Type.ZT_Family;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            {
                darwinCoreInfo.Family = String.Empty;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (base.thisBox.Text.Trim().Length > 0)
            {
                ...
                darwinCoreInfo.Family = base.thisBox.Text.Trim();
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (darwinCoreInfo != null)
            {
                base.thisBox.Text = darwinCoreInfo.Family;
            }
        }
    }
}
