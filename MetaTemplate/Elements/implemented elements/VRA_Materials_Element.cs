...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the materials related to an item and encoded in VRACore.</summary>
    /// <remarks>This class extends the <see cref="keywordScheme_Element"/> object.<br /><br />
    /// Written by Mark Sullivan ( 2011 ).</remarks>
    public class VRA_Materials_Element : keywordScheme_Element
    {
        // <summary> Constructor for a new instance of the VRA_Materials_Element class </summary>
        public VRA_Materials_Element() : base("Materials")
		{
			// Set the type of this object
            base.type = Element_Type.VRA_Material;
			base.display_subtype = "type";
			...
			// Add the schemes
			base.thisSchemeBox.Items.Add("medium");
			base.thisSchemeBox.Items.Add("support");
            base.thisSchemeBox.Items.Add("other");
