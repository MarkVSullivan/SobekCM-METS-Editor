...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the KINGDOM classification associated with a zoological taxonomy </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ZT_Kingdom : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ZT_Kingdom, used in the metadata
        /// template to display and allow the user to edit the kingdom 
        /// classification associated with a zoological taxonomy </summary>
        public ZT_Kingdom() : base("Kingdom")
        {
            // Set the type of this object
            base.type = Element_Type.ZT_Kingdom;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            {
                darwinCoreInfo.Kingdom = String.Empty;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (base.thisBox.Text.Trim().Length > 0)
            {
                ...
                darwinCoreInfo.Kingdom = base.thisBox.Text.Trim();
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (darwinCoreInfo != null)
            {
                base.thisBox.Text = darwinCoreInfo.Kingdom;
            }
        }
    }
}
