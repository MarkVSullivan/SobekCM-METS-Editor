...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the style/period related to an item and encoded in VRACore.</summary>
    ...
    public class VRA_StylePeriod_Element : simpleTextBox_Element
    {
        ...
        public VRA_StylePeriod_Element()
            : base("Style / Period")
        {
            // Set the type of this object
            base.type = Element_Type.VRA_StylePeriod;
