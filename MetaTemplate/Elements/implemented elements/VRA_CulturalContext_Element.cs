...
namespace SobekCM.METS_Editor.Elements
{
    ...
    public class VRA_CulturalContext_Element : simpleTextBox_Element
    {
        ...
        public VRA_CulturalContext_Element()
            : base("Cultural Context")
        {
            // Set the type of this object
            base.type = Element_Type.VRA_CulturalContext;
        ...
        protected override void Inner_Set_Language(Template_Language newLanguage)
        {
            switch (newLanguage)
            {
                ...
                case Template_Language.French:
                    ...
                    break;
                default:
                    base.title = "Cultural Context - unknown";
                    break;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (thisBox.Text.Trim().Length > 0)
            {
                ...
                vraInfo.Add_Cultural_Context(thisBox.Text.Trim());
            }
        }
        ...
        {
            VRACore_Info vraInfo = Bib.Get_Metadata_Module(GlobalVar.VRACORE_METADATA_MODULE_KEY) as VRACore_Info;
            if ((vraInfo != null) && (base.index < vraInfo.Cultural_Context_Count))
            {
                base.thisBox.Text = vraInfo.Cultural_Contexts[base.index];
			}
        }
    }
}