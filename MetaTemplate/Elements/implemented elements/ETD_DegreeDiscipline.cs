...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the degree discipline for an Electronic Thesis and Dissertation (ETD) material </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ETD_DegreeDiscipline : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ETD_Degree, used in the metadata
        /// template to display and allow the user to edit the degree discipline for an 
        /// Electronic Thesis and Dissertation (ETD) material </summary>
        public ETD_DegreeDiscipline()
            : base("Degree Discipline")
        {
            // Set the type of this object
            base.type = Element_Type.ETD_DegreeDiscipline;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            if (thesisInfo != null)
            {
                thesisInfo.Degree_Discipline = String.Empty;
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (thesisInfo != null)
            {
                base.thisBox.Text = thesisInfo.Degree_Discipline;
            }
        }
    }
}
