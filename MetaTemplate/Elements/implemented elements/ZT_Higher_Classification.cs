...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the HIGHER CLASSIFICATION associated with a zoological taxonomy </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ZT_Higher_Classification : simpleTextBox_Element
    {
        /// <summary> Constructor for a new ZT_Higher_Classification, used in the metadata
        /// template to display and allow the user to edit the higher 
        /// classification associated with a zoological taxonomy </summary>
        public ZT_Higher_Classification()
            : base("Higher Classification")
        {
            // Set the type of this object
            base.type = Element_Type.ZT_HigherClassification;
        ...
        public override void Prepare_For_Save(SobekCM_Item Bib)
        {
            ...
            {
                darwinCoreInfo.Higher_Classification = String.Empty;
            }
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (base.thisBox.Text.Trim().Length > 0)
            {
                ...
                darwinCoreInfo.Higher_Classification = base.thisBox.Text.Trim();
            }
        }
        ...
        public override void Populate_From_Bib(SobekCM_Item Bib)
        {
            ...
            if (darwinCoreInfo != null)
            {
                base.thisBox.Text = darwinCoreInfo.Higher_Classification;
            }
        }
    }
}
