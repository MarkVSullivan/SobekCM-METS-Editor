...
namespace SobekCM.METS_Editor.Elements
{
    ...
    /// to edit the committee chair for an Electronic Thesis and Dissertation (ETD) material </summary>
    /// <remarks>This class extends the <see cref="simpleTextBox_Element"/> object.</remarks>
    public class ETD_CommitteeChair : simpleTextBox_Element
    {
        ...
        public ETD_CommitteeChair() : base("Committee Chair")
        {
            // Set the type of this object
            base.type = Element_Type.ETD_CommitteeChair;
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            if (base.thisBox.Text.Trim().Length > 0)
            {
                ...
                thesisInfo.Committee_Chair = base.thisBox.Text.Trim();
            }
        }
