...
namespace SobekCM.METS_Editor.Forms
{
    public partial class Round_Button : UserControl
    {
        ...
        public bool Button_Enabled
        {
            ...
            set
            {
                if (value != button_enabled)
                {
                    ...
                    if (button_enabled)
                    {
                        buttonLabel.Cursor = Cursors.Hand;
                    }
                    else
                    {
                        buttonLabel.Cursor = Cursors.Default;
                    }
                    Invalidate();
                }
            }
        ...
        {
            if ((e.KeyCode == Keys.Tab) || (e.KeyCode == Keys.Up) || (e.KeyCode == Keys.Down) || (e.KeyCode == Keys.Left) || (e.KeyCode == Keys.Right) || (e.KeyCode == Keys.Space) || (e.KeyCode == Keys.Escape))
                base.OnKeyDown(e);
            else
            {
