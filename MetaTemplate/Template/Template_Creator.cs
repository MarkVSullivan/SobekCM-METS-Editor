...
{
    /// <summary> Class is used to create a default template XML file  </summary>
    internal class Template_Creator
    {
        public static void Create(string directory)
        {
            ...
            writer.WriteLine("	<name>UFDC Metadata Template</name>");
            writer.WriteLine("	<name language=\"spa\">Plantilla UFDC</name>");
            writer.WriteLine("	<name language=\"fre\">Calibre UFDC</name>");
            writer.WriteLine("	<notes>Main template for UFDC</notes>");
            ...
            writer.WriteLine("			</panel>");
            writer.WriteLine("			<panel>");
            writer.WriteLine("				<name>Viewers for this resource in UFDC</name>");
            writer.WriteLine("				<element type=\"Viewer\"  repeatable=\"true\" />");
            writer.WriteLine("			</panel>");
            writer.WriteLine("			<panel>");
            writer.WriteLine("				<name>Interfaces for this resource</name>");
            writer.WriteLine("				<element type=\"Interface\" repeatable=\"true\" >");
            writer.WriteLine("					<element_data>");
            writer.WriteLine("						<value>UFDC</value>");
            writer.WriteLine("					</element_data>");
            writer.WriteLine("				</element>");
            writer.WriteLine("			</panel>");
            writer.WriteLine("		</page>");
