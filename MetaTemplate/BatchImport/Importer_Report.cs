...
namespace SobekCM.METS_Editor.BatchImport
{
    public class Importer_Report
    {
        ...
        public DataRow Add_Item( SobekCM_Item bibPackage, string comment )
        {
            // Create the new row
         ...
         //   newRow["ReceivingID"] = bibPackage.Tracking.ReceivingID;
        ...
        //    newRow["Project_Code"] = bibPackage.Processing_Parameters.Collection_Codes;
            report.Rows.Add(newRow);
