 ...
 *=========================================================================*/
		...
		private void computeChecksum()
		{
			...
			try
			{
				...
				FileStream hashFile = new FileStream( fileName, FileMode.Open );
				...
				for ( int i = 0 ; i < result.Length ; i++ )
				{
					...
					byteAsInteger = Convert.ToInt32( result[i] );

					// Convert the integer to hex
					hashResult += GetHex((double) Math.Floor( (double) (byteAsInteger / 16))) + GetHex((double) ( byteAsInteger % 16));
				}
