...
namespace DLC.Tools.StartUp
{
	...
	/// <li type="circle" /> Encrypting and Decrypting strings. [ <see cref="SecurityInfo.EncryptString"/> and <see cref="SecurityInfo.DecryptString"/> ] </li>
	/// <li type="circle" /> Reading and Writing to encrypted files. [ <see cref="SecurityInfo.ReadFromEncryptedFile"/> and <see cref="SecurityInfo.WriteToEncryptedFile"/> ] </li>
	/// <li type="circle" /> Getting machine identifiers [ <see cref="SecurityInfo.MAC_Address"/> and <see cref="SecurityInfo.HardDriveSerial"/> ]  </li>
	/// <li type="circle" /> Reading keys from the Registry. [ <see cref="SecurityInfo.LocalMachineKey"/> and <see cref="SecurityInfo.CurrentUserKey"/> ] </li> 
	/// <li type="circle" /> Getting the current username. [ <see cref="SecurityInfo.UserName"/> ]</li>
	/// </ul> <br /> <br />
	...
	public class SecurityInfo
	{
		...
		public char[] ReadFromEncryptedFile ( string filename, string key, string IV, int position, int length )
		{
			...
			try
			{
				...
				DESProvider.IV = ASCIIEncoding.ASCII.GetBytes(IV);
